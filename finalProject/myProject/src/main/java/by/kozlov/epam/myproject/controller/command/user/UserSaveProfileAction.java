...
public class UserSaveProfileAction extends Action {
    ...
    public Forward execute(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
        ...
        int count_of_tours = Integer.valueOf(req.getParameter("count_of_tours"));
        int id_tour = Integer.valueOf(req.getParameter("id_tour"));
        ...
        if (login != null && !login.isBlank() && password != null && !password.isBlank()){
            ...
            user.setRole(role);
            user.setCount_of_tours(count_of_tours);
            user.setId_tour(id_tour);
            try {
